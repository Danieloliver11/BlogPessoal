...
@RequestMapping("/postagem") // define uma URI para ser consumida no front-end
@CrossOrigin(origins = "*", allowedHeaders ="*")   // aceita requisicao de qualquer origem, seja ela web, mobile etc
